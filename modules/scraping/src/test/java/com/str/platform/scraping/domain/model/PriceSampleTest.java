...
class PriceSampleTest {
    ...
    private static final BigDecimal NIGHTLY_PRICE_200 = new BigDecimal("200.00");
    ...
    class AverageDailyRateCalculation {
        ...
        void shouldCalculateADRCorrectly() {
            ...
            var sample = createSample(NIGHTLY_PRICE_200, THREE_NIGHTS);
        ...
        void shouldCalculateADRForWeekLongStay() {
            ...
            var sample = createSample(new BigDecimal("150.00"), 7);
